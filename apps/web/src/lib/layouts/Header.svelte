...
<header
	use:init
	class="mask-b-from-90% mask-b-to-transparent sticky top-0 z-20 w-full backdrop-blur-3xl"
>
	<div class="relative mx-auto flex h-full w-full max-w-6xl items-center py-5 pl-6 pr-4">
		...
		<div class="relative flex flex-1">
			<Nav class="w-full">
				...
				<Nav.Actions class="ml-auto flex gap-4">
