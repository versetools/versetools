...
import type { AnyFileRoute, inferErrorShape } from "uploadthing/types";
...
export function createUploader<TEndpoint extends keyof UploadsRouter>(
	endpoint: TEndpoint,
	opts?: UploaderOpts<UploadsRouter[TEndpoint]>
) {
