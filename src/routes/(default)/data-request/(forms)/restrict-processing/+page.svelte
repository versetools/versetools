<script lang="ts">
	...
	const form = superForm(data.form, {
		validators: zodClient(RestrictProcessingRequestSchema),
		dataType: "json",
		onResult(event) {
			if (event.result.type === "success") {
				toast({
					type: "assertive",
					title: "Restrict processing request submitted!",
...
<Meta title="Restrict Processing Request" />
...
<Card size="xl">
	<Card.Header>
		...
		<Card.Title class="text-2xl">Restrict Processing Request</Card.Title>
	</Card.Header>
	<Card.Body>
