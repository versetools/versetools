<script lang="ts">
	...
	const form = superForm(data.form, {
		validators: zodClient(CorrectInaccuraciesRequestSchema),
		dataType: "json",
		onResult(event) {
...
<Meta title="Correct Inaccuracies Request" />
...
<Card size="xl">
	<Card.Header>
		...
		<Card.Title class="text-2xl">Correct Inaccuracies Request</Card.Title>
	</Card.Header>
	<Card.Body>
		...
		<Form {form}>
			...
			<Form.Field {form} name="inaccuracies">
				<Form.Control>
					{#snippet children({ props })}
						<Form.Label>What information needs updating?</Form.Label>
						<Textarea
							{...props}
							placeholder="Describe the inaccuracies"
