...
new k8s.networking.v1.Ingress(`${appName}-discord-redirect`, {
	metadata: {
		namespace: namespace.metadata.name,
		name: `${appName}-discord-redirect`,
		annotations: {
			"kubernetes.io/ingress.class": "nginx",
			"nginx.ingress.kubernetes.io/rewrite-target": "https://discord.gg/cWbb2cT2MW"
		}
	},
	spec: {
		rules: [
