...
<button
	...
	class={twMerge(
		"bg-switch border-switch-border border-1 relative h-6 w-12 shrink-0 cursor-pointer rounded-full",
...
>
	<div
		class={twMerge(
			"top-0.75 absolute size-4 rounded-full bg-white transition-transform",
